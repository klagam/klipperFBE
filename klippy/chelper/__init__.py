...
SOURCE_FILES = [
    ...
    'kin_deltesian.c', 'kin_polar.c', 'kin_rotary_delta.c', 'kin_winch.c', 'kin_fivebarelbow.c',
...
defs_all = [
    ...
    defs_kin_deltesian, defs_kin_polar, defs_kin_rotary_delta, defs_kin_winch, defs_kin_fivebarelbow,
